...
public class ImageModelTests {
    ...
    String message1 = """
            ...
            탐사 로버와 2족 보행 로봇에는 모두 "Campus" 로고와 브랜드명이 선명하게 표시되어 있다.
    ...
    String message2 = """
            ...
            Both the rover and the humanoid robot prominently display the brand name and logo "Campus".
    ...
    String message4 = """
            Create a premium Instagram marketing banner for Campus Sun Cream summer UV protection campaign.
            
            Requirements:
            
            * prominently feature the brand name "Campus Sun Cream"
