...
public class OpenAiClientTests {
    ...
    private String prompt = """
            ...
            차량 측면과 보닛에는 “Campus”라는 문구를 크게 넣어 줘.
            
            “Campus” 로고는 실제 레이싱 팀처럼 세련되고 미래적인 스타일로 표현해 줘.
    ...
    public void testImageEdit() throws IOException {
        var resource = resourceLoader.getResource("classpath:image/car.jpg");
        ...
        Files.write(Paths.get("D:/output/openaisdk-image.png"), imageBytes);
    }
}
